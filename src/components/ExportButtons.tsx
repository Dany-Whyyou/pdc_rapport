  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        disabled={!!exporting}
        className="inline-flex items-center gap-2 px-3 py-2 bg-blue-50 text-blue-700 text-sm font-medium rounded-lg hover:bg-blue-100 transition-colors disabled:opacity-50"
      >
        {exporting === 'word' ? (
